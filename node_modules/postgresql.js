...
var insertCityWeather = function(cityAndCountry, dateweather, conditions, temperature, precipitation, humidity) {
	...
	var client = new pg.Client(conString);
        client.connect(function(err) {
                ...
                var query = client.query("WITH upsert AS (UPDATE weathers SET conditions =$3, temperature = $4, precipitation = $5, humidity = $6 WHERE weather_date=$2 AND city = $1 AND country = $7 RETURNING *) INSERT INTO weather (city, country, dateweather, conditions, temperature, precipitation, humidity) SELECT $1, $7,$2, $3, $4, $5, $6 WHERE NOT EXISTS (SELECT * FROM upsert);", [city, dateweather, conditions, temperature, precipitation, humidity, country], function(err, result) {
                        if(err) {
                                console.error('error running query', err);
                                return client.end();
                        }
